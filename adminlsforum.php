...
<p class="subtitulo">Evento próximo: Conselho nacional dos advogados</p>
        </div>
    </div>
    ...
    <div class="parking-info">
        <div class="parking-description">
            ...
            <p class="subtitulo">Vagas ocupadas: 75</p>
            <p class="subtitulo">Vagas disponíveis: 25</p>
            <p class="subtitulo">Capacidade total: 100</p>
            <p class="subtitulo">Ocupação: 75%</p>
        </div>
    </div>
    ...
    <div class="parking-info">
        <div class="parking-description">
            ...
            <p class="subtitulo">Orivaldo - Atendente</p>
            <p class="subtitulo">Joaquim - Manobrista</p>
            <p class="subtitulo">Hermano Filho - Limpador</p>
        </div>
    </div>
